...
export default function NotificacionesPaginas() {
  return (
    <main className="main-block">
      ...
      <div  key={notificacion.id} className={`block-notificaciones__tipo01 ${
        notificacion.leido ? "block-notificaciones--read" : "block-notificaciones--no-leido"
      }`}>
...
//     tiempo: "Hace 5 días",
//     leido: true,
//     mensajePrivado: "Hola, gracias por crear el Club de Ajedrez. Soy miembro desde hace algunas semanas y ya estoy divirtiéndome mucho y mejorando mi juego.",
//   },
//   {
//     id: 5,
//     nombre: "Kimberly Smith",
...
//             Notificaciones{" "}
//           </span>
//           <span className="block-header__notificaciones-numero">
//             {notificacionesData.filter((notificacion) => !notificacion.leido).length}
//           </span>
//         </span>
//         <span className="block-header__marcar-todo">Marcar todo como leído</span>
//       </header>
...
//               <div className="block-notifications__type02-c">
//                 <div className="block-notifications__type02">
//                   {notificacion.mensajePrivado}
//                 </div>
//               </div>
//             )}
